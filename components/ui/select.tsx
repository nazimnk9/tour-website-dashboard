...
function SelectItem({
  ...
  indicatorPlacement?: 'left' | 'right' | 'end'
}) {
  return (
    ...
    >
      <span
        className={cn(
          ...
          indicatorPlacement === 'right' && 'absolute right-2',
          indicatorPlacement === 'right' && 'absolute left-2',
          indicatorPlacement === 'end' && 'relative ml-auto',
        )}
      >
